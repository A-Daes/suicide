...
Input = input("Ingrese una cadena usando cualquier simbolo. Los Operadores son: | (or), * (kleene) y se aceptan parentesis. Aun no hay funcionalidad para epsilon, los espacios cuentan como simbolos tambien!S: ")
